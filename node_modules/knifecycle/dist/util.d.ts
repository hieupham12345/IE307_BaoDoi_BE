...
export type Dependencies<S extends Service = Service> = {
    [name: string]: S;
};
...
export type ProviderInitializerBuilder<D extends Dependencies, S extends Service> = ((dependencies: D) => Promise<Provider<S>>) | ((dependencies?: D) => Promise<Provider<S>>);
...
export type ProviderInitializer<D extends Dependencies, S extends Service> = ((dependencies: D) => Promise<Provider<S>>) | ((dependencies?: D) => Promise<Provider<S>>);
...
export type ServiceInitializerBuilder<D extends Dependencies, S extends Service> = ((dependencies: D) => Promise<S>) | ((dependencies?: D) => Promise<S>);
...
export type ServiceInitializer<D extends Dependencies, S extends Service> = ((dependencies: D) => Promise<S>) | ((dependencies?: D) => Promise<S>);
...
export type InitializerProperties = ConstantProperties | ProviderProperties | ServiceProperties;
export type AsyncInitializerBuilder<D extends Dependencies, S extends Service> = ProviderInitializerBuilder<D, S> | ServiceInitializerBuilder<D, S>;
export type AsyncInitializer<D extends Dependencies, S extends Service> = ServiceInitializer<D, S> | ProviderInitializer<D, S>;
export type PartialAsyncInitializer<D extends Dependencies, S extends Service> = Partial<ServiceInitializer<D, S>> | Partial<ProviderInitializer<D, S>>;
export type Initializer<S extends Service, D extends Dependencies> = ConstantInitializer<S> | ServiceInitializer<D, S> | ProviderInitializer<D, S>;
export type ServiceInitializerWrapper<S extends Service, D extends Dependencies> = (dependencies: D, baseService: S) => Promise<S>;
export type ProviderInitializerWrapper<S extends Service, D extends Dependencies> = (dependencies: D, baseService: Provider<S>) => Promise<Provider<S>>;
export type Parameters<V = any> = {
    [name: string]: V;
};
export type HandlerFunction<D extends Dependencies, V, P extends Parameters<V>, U extends any[], R> = ((dependencies: D, parameters: P, ...args: U) => Promise<R>) | ((dependencies: D, parameters?: P, ...args: U) => Promise<R>);
