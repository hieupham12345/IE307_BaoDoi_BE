...
export type JWTEnvVars<T extends string extends T ? never : string = typeof DEFAULT_JWT_SECRET_ENV_NAME> = Partial<Record<T, string>>;
/**
...
export type JWTServiceConfig<T extends string extends T ? never : string = typeof DEFAULT_JWT_SECRET_ENV_NAME> = {
    JWT_SECRET_ENV_NAME?: T;
    JWT: JWT_CONFIG<T>;
};
export type JWTServiceDependencies<T extends string extends T ? never : string = typeof DEFAULT_JWT_SECRET_ENV_NAME> = JWTServiceConfig<T> & {
    ENV?: JWTEnvVars<T>;
    time?: TimeService;
    log?: LogService;
};
